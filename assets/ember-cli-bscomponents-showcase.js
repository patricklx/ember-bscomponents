...
define('ember-cli-bscomponents-showcase/config/environment', ['ember'], function(Ember) {
  var prefix = 'ember-cli-bscomponents-showcase';
/* jshint ignore:start */
...
if (!runningTests) {
  require("ember-cli-bscomponents-showcase/app")["default"].create({"name":"ember-cli-bscomponents-showcase","version":"0.0.0+e0cd9666"});
}
