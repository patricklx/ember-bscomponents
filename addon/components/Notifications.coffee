...
###
NotificationsView = Ember.CollectionView.extend (
    classNames: ['notifications']
    attributeBindings: ['style']
    contentBinding: 'NM.content'
    showTime: 2000
    fadeInTime: 500
    fadeOutTime: 3000
    ...
    ###
    itemViewClass: BsAlertComponent.extend(
    ...
    itemViewClass: Ember.View.extend(
        ...
        template: Ember.HTMLBars.compile '{{view.content.message}}'
...
Ember.Handlebars.helper 'bs-notifications', NotificationsView

NM = NotificationManager = Ember.Object.create(
    content: Ember.A()
    push: (message, type) ->
        type = type?= 'info'
