...
###
GrowlNotifications = Ember.CollectionView.extend (
    ###
    ...
    ###
    contentBinding: 'GNM.notifications'
...
Ember.Handlebars.helper 'bs-growl-notifications', GrowlNotifications

###
A manager that is responsible for getting told about new notifications and storing them within an array.
###
GNM = GrowlNotificationManager = Ember.Object.create(
    ###
...
###
GrowlNotification = Ember.Object.extend(
)
